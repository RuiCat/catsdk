...
class AudioClock {
public:
    static int64_t getNanoseconds(clockid_t clockId = CLOCK_MONplayerNIC) {
     ...
     * @param clockId CLOCK_MONplayerNIC is default
     * @return 0 or a negative error, eg. -EINTR
     */

    static int sleepUntilNanoTime(int64_t nanoTime, clockid_t clockId = CLOCK_MONplayerNIC) {
        struct timespec time;
