...
typedef SLresult  (*prplayertype_slCreateEngine)(
        SLObjectItf             *pEngine,
        SLuint32                numOptions,
...
static prplayertype_slCreateEngine gFunction_slCreateEngine = nullptr;
...
static bool linkOpenSLES() {
    if (gLibOpenSlesLibraryHandle == nullptr && gFunction_slCreateEngine == nullptr) {
        ...
        if (gLibOpenSlesLibraryHandle == nullptr) {
            ...
            gFunction_slCreateEngine = (prplayertype_slCreateEngine) dlsym(
