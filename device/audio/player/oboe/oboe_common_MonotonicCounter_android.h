...
#ifndef COMMON_MONplayerNIC_COUNTER_H
#define COMMON_MONplayerNIC_COUNTER_H

#include <cstdint>

/**
 * Maintain a 64-bit monplayernic counter.
 ...
 */
class MonplayernicCounter {

public:
    MonplayernicCounter() {}
    virtual ~MonplayernicCounter() {}
...
#endif //COMMON_MONplayerNIC_COUNTER_H
