...
func FindLocalFont(name string, style FontStyle) string {
	log.Println("WARNING: canvascanvas/FindLocalFont is deprecated, please use canvascanvas/FindSystemFont") // TODO: remove
	filename, _ := FindSystemFont(name, style)
	return filename
}

// CacheSystemFonts will write and load the list of system fonts to the given filename. It scans the given directories for fonts, leave nil to use canvasfont/DefaultFontDirs().
...
func LoadLocalFont(name string, style FontStyle) (*Font, error) {
	log.Println("WARNING: canvascanvas/LoadLocalFont is deprecated, please use canvascanvas/LoadSystemFont") // TODO: remove
...
func (family *FontFamily) LoadLocalFont(name string, style FontStyle) error {
	log.Println("WARNING: canvascanvas/FontFamily.LoadLocalFont is deprecated, please use canvascanvas/FontFamily.LoadSystemFont") // TODO: remove
...
func (family *FontFamily) MustLoadLocalFont(name string, style FontStyle) {
	log.Println("WARNING: canvascanvas/FontFamily.MustLoadLocalFont is deprecated, please use canvascanvas/FontFamily.MustLoadSystemFont") // TODO: remove
