...
package testgraph // import "mat/matfun/graph/testgraph"
...
func NewRandomNodes(n int, seed int64, new func(id int64) graph.Node) *RandomNodes {
	return &RandomNodes{
		n:       n,
		seed:    seed,
		newNode: new,
