...
// Lapack defines the public LAPACK API supported by gonum/blas.
type Lapack interface {
	...
	Dgels(trans Transpose, m, n, nrhs int, a []float64, lda int, b []float64, ldb int, work []float64, lwork int) bool
	...
	Dgetrs(trans Transpose, n, nrhs int, a []float64, lda int, ipiv []int, b []float64, ldb int)
	...
	Dlantr(norm MatrixNorm, uplo Uplo, diag Diag, m, n int, a []float64, lda int, work []float64) float64
	Dlange(norm MatrixNorm, m, n int, a []float64, lda int, work []float64) float64
	Dlansy(norm MatrixNorm, uplo Uplo, n int, a []float64, lda int, work []float64) float64
	...
	Dormqr(side Side, trans Transpose, m, n, k int, a []float64, lda int, tau, c []float64, ldc int, work []float64, lwork int)
	Dorglq(m, n, k int, a []float64, lda int, tau, work []float64, lwork int)
	Dormlq(side Side, trans Transpose, m, n, k int, a []float64, lda int, tau, c []float64, ldc int, work []float64, lwork int)
	Dpbcon(uplo Uplo, n, kd int, ab []float64, ldab int, anorm float64, work []float64, iwork []int) float64
	Dpbtrf(uplo Uplo, n, kd int, ab []float64, ldab int) (ok bool)
	Dpbtrs(uplo Uplo, n, kd, nrhs int, ab []float64, ldab int, b []float64, ldb int)
	Dpocon(uplo Uplo, n int, a []float64, lda int, anorm float64, work []float64, iwork []int) float64
	Dpotrf(ul Uplo, n int, a []float64, lda int) (ok bool)
	Dpotri(ul Uplo, n int, a []float64, lda int) (ok bool)
	Dpotrs(ul Uplo, n, nrhs int, a []float64, lda int, b []float64, ldb int)
	Dpstrf(uplo Uplo, n int, a []float64, lda int, piv []int, tol float64, work []float64) (rank int, ok bool)
	Dsyev(jobz EVJob, uplo Uplo, n int, a []float64, lda int, w, work []float64, lwork int) (ok bool)
	Dtbtrs(uplo Uplo, trans Transpose, diag Diag, n, kd, nrhs int, a []float64, lda int, b []float64, ldb int) (ok bool)
	Dtrcon(norm MatrixNorm, uplo Uplo, diag Diag, n int, a []float64, lda int, work []float64, iwork []int) float64
	Dtrtri(uplo Uplo, diag Diag, n int, a []float64, lda int) (ok bool)
	Dtrtrs(uplo Uplo, trans Transpose, diag Diag, n, nrhs int, a []float64, lda int, b []float64, ldb int) (ok bool)
}
