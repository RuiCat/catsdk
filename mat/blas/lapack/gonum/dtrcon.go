...
func (impl Implementation) Dtrcon(norm blas.MatrixNorm, uplo blas.Uplo, diag blas.Diag, n int, a []float64, lda int, work []float64, iwork []int) float64 {
	switch {
	case norm != blas.MaxColumnSum && norm != blas.MaxRowSum:
		panic(badNorm)
