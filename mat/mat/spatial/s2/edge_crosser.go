...
func NewEdgeCrosser(a, b Point) *EdgeCrosser {
	...
	return &EdgeCrosser{
		a:        a,
		b:        b,
		aXb:      Point{a.Cross(b.Vec)},
		aTangent: Point{a.Cross(norm.Vec)},
		bTangent: Point{norm.Cross(b.Vec)},
	}
}
...
func (e *EdgeCrosser) crossingSign(d Point, bda Direction) Crossing {
	...
	if (e.c.Dot(e.aTangent.Vec) > maxError && d.Dot(e.aTangent.Vec) > maxError) || (e.c.Dot(e.bTangent.Vec) > maxError && d.Dot(e.bTangent.Vec) > maxError) {
		return DoNotCross
	}
