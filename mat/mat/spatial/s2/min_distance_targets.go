...
func (m *MinDistanceToEdgeTarget) capBound() Cap {
	...
	return CapFromCenterChordAngle(Point{m.e.V0.Add(m.e.V1.Vec).Normalize()}, s1.ChordAngleFromSquaredLength(r2))
}
...
func (m *MinDistanceToEdgeTarget) visitContainingShapes(index *ShapeIndex, v shapePointVisitorFunc) bool {
	...
	target := NewMinDistanceToPointTarget(Point{m.e.V0.Add(m.e.V1.Vec).Normalize()})
