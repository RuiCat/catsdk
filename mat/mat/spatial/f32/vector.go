...
func (v1 Vec2) Reflect(v2 Vec2) Vec2{
	p := 2 * v1.Dot(v2)
	return Vec2{v1[0] - p * v2[0],v1[1] - p * v2[1]}
}
func (v1 Vec3) Reflect(v2 Vec3) Vec3{
	p := 2 * v1.Dot(v2)
	return Vec3{v1[0] - p * v2[0],v1[1] - p * v2[1],v1[2] - p * v2[2] }
}
func (v1 Vec4) Reflect(v2 Vec4) Vec4{
	p := 2 * v1.Dot(v2)
	return Vec4{v1[0] - p * v2[0],v1[1] - p * v2[1],v1[2] - p * v2[2],v1[3] - p * v2[3]}
}
