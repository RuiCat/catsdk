...
//  twoW 长方形宽
//  twoH 长方形高
func RectangleToRectangle(oneX, oneY, oneW, oneH, twoX, twoY, twoW, twoH float32) bool {
	// x轴方向碰撞？
...
//  twoY 圆心Y坐标
//  twoR 圆形半径
func CircleToCircle(oneX, oneY, oneR, twoX, twoY, twoR float32) bool {
...
//  oneR 圆形半径
//  X, Y 点坐标
func CircleToSpot(oneX, oneY, oneR, X, Y float32) bool {
...
//  oneH 长方形高
//  X, Y 点坐标
func RectangleToSpot(oneX, oneY, oneW, oneH, X, Y float32) bool {
...
//  rectW  长方形宽
//  rectH  长方形高
func CircleToRectangle(arcOx, arcOy, arcR, rectX, rectY, rectW, rectH float32) bool {
