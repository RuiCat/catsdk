# CSS [![API reference](https://img.shields.io/badge/godoc-reference-5272B4)](https://pkg.go.dev/canvasparse/v2/css?tab=doc)
...
Run the following command
	...
	go get -u canvasparse/v2/css

or add the following import and run project with `go get`

	import "sdk/parse/v2/css"
