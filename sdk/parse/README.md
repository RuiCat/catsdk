...
The lexers are implemented using `buffer.Lexer` in https://canvasparse/buffer and the parsers work on top of the lexers. Some subpackages have hashes defined (using [Hasher](https://canvashasher)) that speed up common byte-slice comparisons.
...
[See README here](https://canvasparse/tree/master/css).
...
[See README here](https://canvasparse/tree/master/html).
...
[See README here](https://canvasparse/tree/master/js).
...
[See README here](https://canvasparse/tree/master/json).
...
[See README here](https://canvasparse/tree/master/xml).
