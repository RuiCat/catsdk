# Font [![API reference](https://img.shields.io/badge/godoc-reference-5272B4)](https://pkg.go.dev/canvasfont?tab=doc)

**[fontcmd](https://canvasfont/tree/master/cmd/fontcmd)**: font toolkit that can select a subset of glyphs from a font, merge fonts, or show font information and display glyphs in the command line or as a raster image.
