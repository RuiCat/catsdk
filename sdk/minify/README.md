# Minify <a name="minify"></a> [![API reference](https://img.shields.io/badge/godoc-reference-5272B4)](https://pkg.go.dev/canvasminify/v2?tab=doc) [![Go Report Card](https://goreportcard.com/badge/canvasminify)](https://goreportcard.com/report/canvasminify) [![codecov](https://codecov.io/gh/tdewolff/minify/branch/master/graph/badge.svg?token=Cr7r2EKPj2)](https://codecov.io/gh/tdewolff/minify)

**[Online demo](https://go.tacodewolff.nl/minify)** if you need to minify files *now*.

**[Binaries](https://canvasminify/releases) of CLI for various platforms.** See [CLI](https://canvasminify/tree/master/cmd/minify) for more installation instructions.
...
See [CLI tool](https://canvasminify/tree/master/cmd/minify) for installation instructions of the binary.
...
## Testing
For all subpackages and the imported `parse` package, test coverage of 100% is pursued. Besides full coverage, the minifiers are [fuzz tested](https://canvasfuzz) using [github.com/dvyukov/go-fuzz](http://www.github.com/dvyukov/go-fuzz), see [the wiki](https://canvasminify/wiki) for the most important bugs found by fuzz testing. These tests ensure that everything works as intended and that the code does not crash (whatever the input). If you still encounter a bug, please file a [bug report](https://canvasminify/issues)!
...
- [minify](https://canvasminify): `minify -o script.min.js script.js`
